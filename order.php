            ...
            <div class="order-small_wrap">
                <div class="address">
                    ...
                    <div class="address-item">
                        ...
                        <div class="add-item_sel">
                            <input type="text" placeholder="Tên người nhận" name="psw" required>
                        </div>
                    </div>
                    ...
                    <div class="address-item">
                        ...
                        <div class="add-item_sel">
                            <input type="text" placeholder="Số điện thoại" max="11" name="psw" required>
                        </div>
                    </div>
                    ...
                    <div class="address-item">
                        ...
                        <div class="add-item_sel">
                            <input type="text" placeholder="Số nhà/tên đường" name="psw" required>
                        </div>
                    </div>
