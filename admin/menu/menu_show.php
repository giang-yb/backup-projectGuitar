                ...
                <div class="table-cart_left">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a type="button" href="menu.php?page_layout=edit&menu_id=<?php echo $row['menu_id'];?>">Edit</a></td>
                            <td><a type="button" href="menu.php?page_layout=delete&menu_id=<?php echo $row['menu_id'];?>">Delete</a></td>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                        </table>
