                ...
                <div class="table-cart_left">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a type="button" href="user.php?page_layout=edit&user_id=<?php echo $row['user_id'];?>">Edit</a></td>
                            <td><a type="button" href="user.php?page_layout=delete&user_id=<?php echo $row['user_id'];?>">Delete</a></td>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                        </table>
